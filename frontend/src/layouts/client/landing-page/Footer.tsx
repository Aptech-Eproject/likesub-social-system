    ...
    <div className="flex items-center justify-center bg-gray-100 bg-amber-500">
      <footer className="w-full bg-[#0f172a]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-16 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              <p className="py-8 text-gray-400 lg:max-w-xs text-center lg:text-left">
                Trusted in more than 100
                countries & 5 million customers. Have any query ?
              </p>
              <a href="javascript:void(0)"
                className="py-2.5 px-5 block w-fit bg-linear-to-r from-cyan-400 to-green-300 hover:from-cyan-500 hover:to-green-400 rounded-full shadow-sm text-white mx-auto transition-all duration-500 lg:mx-0 font-semibold">
                Contact us
              </a>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
              <h4 className="text-lg text-gray-200 font-bold mb-7">Pagedone</h4>
              <ul className=" transition-all duration-500">
                <li className="mb-6"><a href="javascript:void(0)" className="text-gray-400 hover:text-gray-500">Home</a></li>
                <li className="mb-6"><a href="javascript:void(0)" className=" text-gray-400 hover:text-gray-500">About</a></li>
                <li><a href="javascript:void(0)" className=" text-gray-400 hover:text-gray-500">Pricing</a></li>
              </ul>
            </div>
            ...
            {/* <!--End Col--> */}
            <div className="lg:mx-auto text-left ">
              <h4 className="text-lg text-gray-200 font-bold mb-7">
                Subscribe
              </h4>
              <p className="text-gray-400 leading-6 mb-7">
              ...
              <a href="javascript:void(0)"
                ...
                <svg
                  ...
                  <path
                    ...
                    stroke="#00D3F3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              ...
              <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                ...
                <a href="javascript:void(0)" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                      ">
